...
//admin-auth model
export const AdminModel: Model<AdminType> = (mongoose.models.admin_info as any) || model<AdminType>(
  "admin_info",
  AdminSchema,
  "admin_info"
);
...
//blog-post model
export const BlogModel: Model<BlogType> = (mongoose.models.blog_post as any) || model<BlogType>("blog_post", BlogSchema, "blog_post");
export const CaseStudyModel: Model<CaseStudyType> = (mongoose.models.caseStudy_post as any) || model<CaseStudyType>(
  "caseStudy_post",
  CaseStudySchema,
  "caseStudy_post"
);
...
//article-post model
export const ArticleModel: Model<BlogType> = (mongoose.models.article_post as any) || model<BlogType>(
  "article_post",
  ArticleSchema,
  "article_post"
);
...
export const NewsLetterModel: Model<NewsLetterType> = (mongoose.models.newsletter_info as any) || model<NewsLetterType>(
  "newsletter_info",
  NewsLetterSchema,
  "newsletter_info"
);
...
//contact-data
export const ContactModel: Model<ContactType> = (mongoose.models.contact_data as any) || model<ContactType>(
  "contact_data",
  ContactSchema,
  "contact_data"
);

export const FootprintModel: Model<FootprintType> = (mongoose.models.footprint as any) || model<FootprintType>(
  "footprint",
  FootprintSchema,
  "footprint"
);
